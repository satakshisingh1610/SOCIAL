          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="relative p-8 md:p-10 h-64 md:h-80 flex flex-col justify-end">
                <span className="inline-block px-3 py-1 bg-background/80 backdrop-blur-sm rounded-full text-xs font-medium text-foreground w-fit mb-4">
                  {project.category}
                </span>
                ...
                <div className="absolute top-8 right-8 w-12 h-12 rounded-full bg-background/80 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-4 group-hover:translate-x-0">
