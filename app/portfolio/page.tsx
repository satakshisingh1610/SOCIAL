            ...
            >
              {filteredProjects.map((project, index) => (
                <motion.div
                  ...
                  transition={{ duration: 0.3, delay: index * 0.05 }}
                  layoutId={project.id}
                  className="group relative overflow-hidden rounded-3xl bg-gradient-to-br border border-border hover:shadow-2xl transition-all duration-500"
                >
                  <motion.div 
                    ...
                    whileHover={{ scale: 1.05 }}
                  />
                  <motion.div className="relative p-8 md:p-10 min-h-[320px] flex flex-col justify-between">
                    <div>
                      <motion.span 
                        className="inline-block px-3 py-1 bg-background/80 backdrop-blur-sm rounded-full text-xs font-medium text-foreground w-fit mb-4"
                        whileHover={{ scale: 1.1 }}
                      >
                        {project.category}
                      </motion.span>
                      <motion.h3 
                        className="text-2xl md:text-3xl font-bold text-foreground mb-3 group-hover:translate-x-2 transition-transform duration-300"
                        whileHover={{ x: 4 }}
                      >
                        {project.title}
                      </motion.h3>
                    ...
                    <div className="flex items-center justify-between">
                      <motion.div 
                        className="bg-background/80 backdrop-blur-sm rounded-full px-4 py-2"
                        whileHover={{ scale: 1.05 }}
                      >
                      ...
                      <motion.div 
                        className="w-12 h-12 rounded-full bg-background/80 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-4 group-hover:translate-x-0"
