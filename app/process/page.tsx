      ...
      <section className="py-16 bg-card overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:flex items-center justify-between relative mb-16">
            ...
            <div className="absolute top-6 left-0 right-0 h-1 bg-gradient-to-r from-primary via-accent to-primary" style={{ width: '100%' }} />
            
            {steps.map((step, index) => (
              <div key={step.number} className="relative z-10 flex flex-col items-center">
                <div className={`w-12 h-12 rounded-full ${step.iconColor} flex items-center justify-center shadow-lg`}>
              ...
              >
                ...
                <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className={`w-14 h-14 ${step.iconColor} rounded-2xl flex items-center justify-center`}>
                ...
                <div className={index % 2 === 1 ? "lg:order-1" : ""}>
                  <div className={`aspect-square rounded-3xl bg-gradient-to-br ${step.color} p-8 relative overflow-hidden`}>
